import { Box, Button, Stack, TextField, Typography, Dialog, DialogTitle } from "@mui/material";
...
function AddPhrase(props) {
    ...
    return isCompressed
        ...
        : <Dialog open={!isCompressed} onClose={() => setIsCompressed(true)} fullWidth maxWidth="md" sx={{ top: "30%"}}>
            <DialogTitle sx={{ textAlign: "center", fontSize: "h5.fontSize" }}>
                Agregar una frase
            </DialogTitle>
            <Stack direction="row" alignItems="baseline" sx={{ ...sectionFrameStyle, mx: 6 }} /* className={classes.addPhraseFrame} */>
